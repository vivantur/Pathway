...
export const COMPANION_CATALOG: CompanionType[] = [
  ...
  },
  {
    slug: "antelope",
    name: "Antelope",
    size: "medium", // docs: "Medium or Large"
    hp: 6,
    abilityMods: { str: 2, dex: 3, con: 2, int: -4, wis: 1, cha: 0 },
    skill: "survival",
    speed: "walk 40 feet",
    senses: ["low-light vision"],
    attacks: [{ name: "horns", traits: ["finesse"], damageDie: "1d6", damageType: "piercing" }, { name: "hoof", traits: ["agile","finesse"], damageDie: "1d4", damageType: "bludgeoning" }],
    support: "The antelope impales your distracted foes. Until the start of your next turn, while riding your antelope, your Strikes that damage a creature in your antelope's reach also deal 1d6 persistent bleed damage. If your antelope is nimble or savage, the persistent bleed damage increases to 2d6.",
  ...
  },
  {
    ...
    abilityMods: { str: 2, dex: 3, con: 2, int: -4, wis: 1, cha: 0 },
    skill: "stealth",
    speed: "walk 10 feet, swim 30 feet",
    senses: ["low-light vision"],
    attacks: [{ name: "beak", traits: ["finesse"], damageDie: "1d6", damageType: "piercing" }, { name: "arm", traits: ["agile","finesse"], damageDie: "1d4", damageType: "bludgeoning" }],
    support: "Your cephalopod squirts ink into your foe's face. Until the start of your next turn, if you hit and deal damage to a creature in your cephalopod's reach, the creature takes a –1 circumstance penalty to their attacks until the start of your next turn.",
    source: "High Seas",
  },
  {
    slug: "chetamog",
  ...
  },
  {
    slug: "durian crab",
    name: "Durian Crab",
    size: "small", // docs: "Small or Medium"
    hp: 6,
    abilityMods: { str: 3, dex: 2, con: 1, int: -4, wis: 2, cha: 0 },
    skill: "stealth",
    speed: "walk 20 feet, climb 20 feet, swim 20 feet",
    senses: ["darkvision"],
    attacks: [{ name: "claw", traits: ["agile"], damageDie: "1d6", damageType: "piercing" }],
    support: "Your durian crab launches itself as part of your ranged attack. Until the start of your next turn, as long as your crab is within your reach, your ranged Strikes that deal damage to a creature within 30 feet make the target off-guard until the end of your next turn. Your crab returns to the same space immediately after making a Strike.",
  ...
  },
  {
    ...
    speed: "walk 35 feet",
    senses: ["low-light vision","scent (imprecise, 30 feet)"],
    attacks: [{ name: "tusk", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "foot", traits: [], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "Your elephant trumpets noisily. The first creature within your elephant's reach that you hit and deal damage to before the start of your next turn takes a –4 status penalty to purely auditory Perception checks until the end of your next turn.",
    source: "Pathfinder #177",
  },
  {
    slug: "elk",
    name: "Elk",
    ...
    speed: "walk 30 feet",
    senses: ["low-light vision"],
    attacks: [{ name: "antlers", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "hoof", traits: ["agile"], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "Your elk makes a threatening display by waving its antlers. Until the start of your next turn, if you hit and deal damage to a creature within your elk's reach, the creature is frightened 1.",
    source: "Howl of the Wild",
  },
  {
    slug: "fire elemental",
  ...
  },
  {
    ...
    senses: ["low-light vision","scent (imprecise) 30 feet"],
    attacks: [{ name: "jaws", traits: ["finesse"], damageDie: "1d6", damageType: "piercing" }, { name: "claw", traits: ["agile","finesse"], damageDie: "1d4", damageType: "slashing" }],
    support: "Your flying squirrel wraps your foes in its skin flaps. Until the end of your next turn, if your Strike damages a creature in its reach, that creature takes a –10-foot circumstance penalty to its Speeds for 1 round.",
    source: "Howl of the Wild",
  },
  {
    slug: "ghost",
    ...
    size: "small", // docs: "Small or Medium"
    hp: 4,
    abilityMods: { str: -5, dex: 3, con: 0, int: -4, wis: 1, cha: 2 },
    skill: "stealth",
    speed: "fly 20 feet",
    senses: ["darkvision"],
    attacks: [{ name: "ghostly touch", traits: ["finesse","magical"], damageDie: "1d8", damageType: "negative" }], // docs: doesn't apply the ghost's Strength modifier
    support: "Your ghost spooks and scares your foes as you attack them. Until the start of your next turn, if you hit and deal damage to a creature in your ghost's reach, the creature becomes frightened 1.",
  ...
  },
  {
    ...
    abilityMods: { str: 3, dex: 1, con: 2, int: -4, wis: 2, cha: 0 },
    skill: "stealth",
    speed: "walk 10 feet, swim 40 feet",
    senses: ["low-light vision","scent (imprecise) 30 feet"],
    attacks: [{ name: "jaws", traits: [], damageDie: "1d8", damageType: "piercing" }],
    support: "Your giant eel swims in confounding bursts. Until the start of your next turn, it counts as being in its space or an empty space of your choice within 10 feet for flanking; you can choose a different space for each of your attacks.",
    source: "Howl of the Wild",
    minLevel: 4,
  },
  {
    ...
    skill: "survival",
    speed: "walk 20 feet, climb 20 feet, swim 25 feet",
    senses: ["low-light vision"],
    attacks: [{ name: "jaws", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "tongue", traits: ["reach 15 feet"], damageDie: "1d4", damageType: "bludgeoning" }],
    support: "Until the start of your next turn, whenever you successfully Strike a creature your giant frog threatens, that creature can't use reactions triggered by your actions unless its level is higher than yours.",
    source: "Howl of the Wild",
    minLevel: 6,
  },
  {
  ...
  },
  {
    ...
    senses: ["darkvision"],
    attacks: [{ name: "stinger", traits: ["finesse"], damageDie: "1d6", damageType: "piercing" }], // docs: "plus poison"
    support: "Your wasp drones its wings, unnerving your enemies. Until the start of your next turn, if you hit and deal damage to a creature in its reach, the creature becomes frightened 1.",
    source: "Howl of the Wild",
    minLevel: 14,
  },
  {
    ...
    speed: "walk 35 feet",
    senses: ["low-light vision","scent (imprecise) 30 feet"],
    attacks: [{ name: "hoof", traits: ["agile"], damageDie: "1d6", damageType: "bludgeoning" }, { name: "neck", traits: ["nonlethal","reach 10 feet"], damageDie: "1d4", damageType: "bludgeoning" }],
    support: "While riding your giraffe this turn, you do not need a hand free to Shove and any foe you successfully Shove moves 10 feet (15 feet on a critical success).",
    source: "Howl of the Wild",
  },
  {
    slug: "goat",
  ...
  },
  {
    ...
    abilityMods: { str: 3, dex: 2, con: 2, int: -4, wis: 1, cha: 0 },
    skill: "survival",
    speed: "walk 25 feet, fly 60 feet",
    senses: ["darkvision","scent (imprecise) 30 feet"],
    attacks: [{ name: "beak", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "talon", traits: ["agile"], damageDie: "1d6", damageType: "slashing" }],
    support: "Your griffon adopts a noble pose. Until the start of your next turn, you and your griffon gain a +2 circumstance bonus to saves against emotion effects.",
    source: "Howl of the Wild",
    minLevel: 14,
  },
  {
    ...
    abilityMods: { str: 2, dex: 3, con: 2, int: -4, wis: 1, cha: 0 },
    skill: "stealth",
    speed: "walk 20 feet, burrow 15 feet, swim 20 feet",
    senses: ["low-light vision","scent (imprecise, 30 feet)"],
    attacks: [{ name: "fangs", traits: ["agile","finesse"], damageDie: "1d6", damageType: "piercing" }],
    support: "Your hermit krait bites at your foes with venomous fangs. Until the start of your next turn, your Strikes that damage a creature in its reach also deal 1d6 persistent poison damage (2d6 if nimble or savage).",
    source: "Tian Xia Character Guide",
  },
  {
    slug: "hippocampus",
    ...
    abilityMods: { str: 3, dex: 1, con: 3, int: -4, wis: 1, cha: 0 },
    skill: "survival",
    speed: "walk 5 feet, swim 40 feet",
    senses: ["darkvision","scent (imprecise) 30 feet"],
    attacks: [{ name: "tail", traits: [], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "Until the start of your next turn, if you're mounted on your hippocampus and moved 10 feet or more on the action before a melee Strike, add a circumstance bonus to damage equal to twice the number of weapon damage dice (jousting weapons: increase the trait's bonus by 2 per die instead).",
    source: "Howl of the Wild",
    minLevel: 4,
  },
  {
    ...
    senses: ["darkvision","scent (imprecise) 30 feet"],
    attacks: [{ name: "beak", traits: [], damageDie: "1d6", damageType: "piercing" }, { name: "talon", traits: ["agile"], damageDie: "1d4", damageType: "slashing" }],
    support: "As hippocampus (mounted-charge damage bonus).",
    source: "Howl of the Wild",
    minLevel: 14,
  },
  {
  ...
  {
    slug: "iridescent salamander",
    name: "Iridescent Salamander",
    size: "small",
    hp: 6,
    abilityMods: { str: 2, dex: 3, con: 2, int: -4, wis: 1, cha: 0 },
    skill: "survival",
    ...
    senses: ["darkvision"],
    attacks: [{ name: "jaws", traits: ["finesse"], damageDie: "1d6", damageType: "piercing" }],
    support: "Until the start of your next turn, if you hit and deal damage to a creature adjacent to your salamander, the creature is dazzled until the start of your next turn unless its level is higher than yours.",
    source: "High Seas",
  },
  {
    slug: "isgeri boarhound",
    name: "Isgeri Boarhound",
    size: "small",
    hp: 6,
    abilityMods: { str: 2, dex: 3, con: 2, int: -4, wis: 1, cha: 0 },
    skill: "survival",
    speed: "walk 40 feet",
    senses: ["foe scent (precise, 40 feet)","scent (imprecise) 40 feet"],
    attacks: [{ name: "jaws", traits: ["finesse"], damageDie: "1d8", damageType: "piercing" }],
    support: "+1 circumstance bonus to your next attack roll to Strike a foe within its reach (until used or your next turn); if you damage its designated-foe-trait creature with that Strike, +1d6 piercing from the boarhound (2d6 if nimble or savage).",
    source: "Pathfinder #222",
  },
  {
    slug: "kangaroo",
    name: "Kangaroo",
    ...
    speed: "walk 30 feet",
    senses: ["low-light vision"],
    attacks: [{ name: "foot", traits: ["agile"], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "Your kangaroo bounces back and forth. Until the start of your next turn, it counts as being in its space or an empty space within 5 feet for flanking; you can choose a different space per attack.",
    source: "Howl of the Wild",
  },
  {
    slug: "keulia",
  ...
  },
  {
    ...
    senses: ["low-light vision","scent (imprecise, 30 feet)"],
    attacks: [{ name: "hoof", traits: ["agile"], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "Your legchair moves its limbs in the way of enemy attacks. You gain lesser cover from your legchair against all attacks.",
    source: "Grand Bazaar",
  },
  {
  ...
  },
  {
    ...
    abilityMods: { str: 3, dex: 2, con: 2, int: -4, wis: 1, cha: 0 },
    skill: "stealth",
    speed: "walk 25 feet, burrow 20 feet",
    senses: ["low-light vision","scent (imprecise) 30 feet"],
    attacks: [{ name: "jaws", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "claw", traits: ["agile"], damageDie: "1d6", damageType: "slashing" }],
    support: "Until the end of your next turn, if you hit and damage a creature adjacent to your mole, that creature is clumsy 1 until it moves from its current position.",
    source: "Howl of the Wild",
  },
  {
    slug: "mongoose",
    ...
    skill: "survival",
    speed: "walk 25 feet, burrow 10 feet",
    senses: ["low-light vision","scent (imprecise) 30 feet"],
    attacks: [{ name: "jaws", traits: ["finesse"], damageDie: "1d6", damageType: "piercing" }, { name: "claw", traits: ["agile","finesse"], damageDie: "1d4", damageType: "slashing" }],
    support: "The mongoose bounds to your side. Until the end of your next turn, creatures adjacent to the mongoose cannot flank you.",
    source: "Howl of the Wild",
  },
  {
    slug: "monitor lizard",
  ...
  },
  {
    ...
    size: "medium", // docs: "Medium or Large"
    hp: 6,
    abilityMods: { str: 3, dex: 2, con: 3, int: -4, wis: 0, cha: 0 },
    skill: "athletics",
    speed: "walk 20 feet",
    senses: ["motion sense (imprecise, 30 feet)"],
    attacks: [{ name: "pseudopod", traits: ["agile"], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "A pseudopod retrieves an unattended object within 15 feet, handing it to you (or dropping it in your space).",
  ...
  },
  {
    ...
    skill: "survival",
    speed: "walk 5 feet, swim 40 feet",
    senses: ["echolocation 30 feet (precise hearing underwater)"],
    attacks: [{ name: "jaws", traits: [], damageDie: "1d8", damageType: "piercing" }],
    support: "Until the start of your next turn, each time you hit a swimming creature in the orca's reach, the target is pulled 5 feet down into the water (forced movement).",
    source: "Howl of the Wild",
    minLevel: 6,
  },
  {
  ...
  },
  {
    ...
    speed: "swim 35 feet",
    senses: ["low-light vision"],
    attacks: [{ name: "spines", traits: ["finesse"], damageDie: "1d6", damageType: "piercing" }], // docs: "plus poison"
    support: "Until the start of your next turn, your Strikes that damage a creature in its reach also deal 1d6 persistent poison damage (2d6 if nimble or savage).",
    source: "High Seas",
  },
  {
    slug: "rhinoceros",
    ...
    speed: "walk 30 feet",
    senses: ["scent (imprecise, 30 feet)"],
    attacks: [{ name: "horn", traits: [], damageDie: "1d8", damageType: "piercing" }],
    support: "The first creature within your rhino's reach that you hit and deal damage to before the start of your next turn becomes clumsy 1 until the end of your next turn.",
    source: "Pathfinder #177",
  },
  {
    slug: "riding dragonet",
    name: "Riding Dragonet",
    size: "small",
    hp: 8,
    abilityMods: { str: 1, dex: 3, con: 2, int: -4, wis: 1, cha: 3 },
    skill: "diplomacy",
    speed: "walk 30 feet",
    senses: ["darkvision"],
    attacks: [{ name: "claw", traits: ["finesse","magical"], damageDie: "1d8", damageType: "bludgeoning" }, { name: "tail", traits: ["agile","finesse","magical"], damageDie: "1d6", damageType: "slashing" }],
    support: "Until the start of your next turn, each time you Strike while riding the dragonet and hit a creature in its reach, the creature takes 1d4 bludgeoning damage (2d4 if nimble or savage).",
  ...
  },
  {
    ...
    abilityMods: { str: 2, dex: 3, con: 1, int: -4, wis: 2, cha: 0 },
    skill: "stealth",
    speed: "walk 30 feet, climb 30 feet",
    senses: ["darkvision"],
    attacks: [{ name: "fangs", traits: ["finesse"], damageDie: "1d6", damageType: "piercing" }, { name: "leg", traits: ["agile","finesse"], damageDie: "1d4", damageType: "piercing" }], // docs: fangs "plus poison"; mount at 8th level
    support: "Until the start of your next turn, if you hit and deal damage to a creature it threatens, the target must succeed at a DC 5 flat check whenever it takes a concentrate action or the action is lost.",
    source: "Howl of the Wild",
    minLevel: 6,
  },
  {
    ...
    abilityMods: { str: 3, dex: 1, con: 3, int: -4, wis: 1, cha: 0 },
    skill: "intimidation",
    speed: "walk 15 feet, fly 60 feet",
    senses: ["low-light vision"],
    attacks: [{ name: "beak", traits: [], damageDie: "1d10", damageType: "piercing" }, { name: "talon", traits: ["agile"], damageDie: "1d8", damageType: "slashing" }], // docs: talon "plus Grab"
    support: "Until the start of your next turn, your Strikes that damage a creature that your roc threatens push the target 5 feet away from your roc.",
    source: "Howl of the Wild",
    minLevel: 16,
  },
  {
    ...
    speed: "walk 30 feet",
    senses: ["low-light vision"],
    attacks: [{ name: "vine", traits: ["reach 10 feet"], damageDie: "1d8", damageType: "slashing" }],
    support: "It ignores difficult terrain until the end of the turn, and Strides.",
    source: "Treasure Vault (Remastered)",
  },
  {
    slug: "salamander",
    ...
    abilityMods: { str: 2, dex: 2, con: 2, int: -4, wis: 1, cha: 1 },
    skill: "survival",
    speed: "walk 20 feet, swim 10 feet",
    senses: ["darkvision"],
    attacks: [{ name: "tail", traits: [], damageDie: "1d6", damageType: "bludgeoning" }, { name: "jaws", traits: [], damageDie: "1d4", damageType: "piercing" }],
    support: "Until the start of your next turn, if you or your salamander are hit by a creature adjacent to the salamander, that creature takes 1d6 poison damage (2d6 if nimble or savage).",
    source: "Howl of the Wild",
  },
  {
    slug: "scorpion",
  ...
  },
  {
    ...
    size: "medium", // docs: "Medium or Large"
    hp: 8,
    abilityMods: { str: 2, dex: 3, con: 2, int: -3, wis: 1, cha: 2 },
    skill: "survival",
    speed: "walk 40 feet",
    senses: ["darkvision"],
    attacks: [{ name: "claw", traits: ["agile"], damageDie: "1d6", damageType: "slashing" }],
    support: "Until the start of your next turn, each time you hit a creature in its reach with a Strike, the creature takes 1d6 mental damage (2d6 if nimble or savage).",
    source: "Howl of the Wild",
  },
  {
    slug: "silt frog",
    ...
    abilityMods: { str: 3, dex: 2, con: 2, int: -4, wis: 1, cha: 0 },
    skill: "stealth",
    speed: "walk 25 feet, burrow 15 feet, swim 25 feet",
    senses: ["low-light vision","magic sense (imprecise) 30 feet"],
    attacks: [{ name: "jaws", traits: [], damageDie: "1d6", damageType: "piercing" }, { name: "tongue", traits: ["reach 10 feet"], damageDie: "1d4", damageType: "bludgeoning" }],
    support: "Until the start of your next turn, if you hit and deal damage to a creature within its reach, the creature is deafened until the start of your next turn.",
    source: "High Seas",
  },
  {
    slug: "skeletal bird of prey",
    name: "Skeletal Bird of Prey",
    size: "small",
    hp: 4,
    abilityMods: { str: 2, dex: 3, con: 1, int: -5, wis: 0, cha: 0 },
    skill: "none (mindless)",
    speed: "walk 10 feet, fly 50 feet",
    senses: ["darkvision"],
    attacks: [{ name: "jaws", traits: ["finesse"], damageDie: "1d6", damageType: "piercing" }, { name: "talon", traits: ["agile","finesse"], damageDie: "1d4", damageType: "slashing" }],
    support: "Until the start of your next turn, when you damage a creature in the bird's reach with a Strike, that creature becomes clumsy 1 until the end of your next turn.",
    source: "Pathfinder #181",
  },
  {
    slug: "skeletal constrictor",
    name: "Skeletal Constrictor",
    size: "small",
    hp: 4,
    abilityMods: { str: 2, dex: 2, con: 1, int: -5, wis: 1, cha: 0 },
    skill: "none (mindless)",
    speed: "walk 20 feet, climb 20 feet, swim 20 feet",
    senses: ["darkvision"],
    attacks: [{ name: "jaws", traits: ["finesse"], damageDie: "1d8", damageType: "piercing" }],
    support: "Choose one creature within 20 feet of the constrictor that can see it. Until the start of your next turn, your Strikes that deal damage to the chosen creature make the target flat-footed until the end of your next turn.",
    source: "Pathfinder #181",
  },
  {
    slug: "skeletal mount",
    ...
    size: "large",
    hp: 4,
    abilityMods: { str: 2, dex: 2, con: 2, int: -5, wis: 0, cha: 0 },
    skill: "none (mindless)",
    speed: "walk 35 feet",
    senses: ["darkvision"],
    attacks: [{ name: "hoof", traits: ["agile"], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "Until the start of your next turn, if you are riding your skeletal mount and move at least 10 feet on the action before your attack, any creature damaged by the attack becomes frightened 1 (frightened 2 on a critical hit). Emotion, fear, mental.",
    source: "Book of the Dead",
  },
  {
    ...
    size: "small", // docs: "Small or Medium"
    hp: 4,
    abilityMods: { str: 2, dex: 2, con: 1, int: -5, wis: 0, cha: 1 },
    skill: "none (mindless)",
    speed: "walk 20 feet",
    senses: ["darkvision"],
    attacks: [{ name: "jaws", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "claw", traits: ["agile"], damageDie: "1d6", damageType: "slashing" }],
    support: "Until the start of your next turn, when a Strike you make hits and deals damage to a creature within its reach, the target becomes flat-footed until the end of your next turn.",
    source: "Book of the Dead",
  },
  {
    slug: "snake",
  ...
  },
  {
    ...
    abilityMods: { str: 2, dex: 3, con: 1, int: -4, wis: 1, cha: 1 },
    skill: "performance",
    speed: "walk 20 feet, swim 15 feet",
    senses: ["low-light vision","scent (imprecise, 30 feet)"],
    attacks: [{ name: "clubbed tail", traits: [], damageDie: "1d8", damageType: "bludgeoning" }, { name: "claws", traits: ["agile"], damageDie: "1d6", damageType: "slashing" }],
    support: "Choose one ally within 30 feet; they gain a +1 circumstance bonus to their next attack roll to Strike a foe within the sundaflora's reach (until used or your next turn).",
    source: "Tian Xia Character Guide",
  },
  {
    slug: "terror bird",
  ...
  },
  {
    ...
    size: "large",
    hp: 8,
    abilityMods: { str: 3, dex: 1, con: 2, int: -3, wis: 0, cha: 2 },
    skill: "intimidation",
    speed: "walk 35 feet",
    senses: ["darkvision","scent (imprecise) 30 feet"],
    attacks: [{ name: "jaws", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "foot", traits: [], damageDie: "1d8", damageType: "bludgeoning" }],
    support: "Until the start of your next turn, your Strikes that damage a creature in its reach also deal 1d6 persistent fire damage (2d6 if nimble or savage).",
    source: "Pathfinder #223",
    minLevel: 14,
  },
  {
    slug: "tikar urchinpad",
    ...
    attacks: [{ name: "tendril", traits: ["agile","finesse"], damageDie: "1d6", damageType: "slashing" }],
    support: "Until the end of your next turn, as long as you're adjacent to your urchinpad, if you attempt to Shove or Trip an opponent and roll a critical failure, you get a failure instead.",
    source: "Tian Xia Character Guide",
  },
  {
    slug: "triceratops",
    ...
    speed: "walk 25 feet",
    senses: ["low-light vision","scent (imprecise, 30 feet)"],
    attacks: [{ name: "horn", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "foot", traits: [], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "Until the start of your next turn, your Strikes that damage a prone creature in its reach also deal 1d8 persistent bleed damage (2d8 if nimble or savage).",
    source: "Pathfinder #177",
  },
  {
    slug: "tyrannosaurus",
    ...
    speed: "walk 35 feet",
    senses: ["low-light vision","scent (imprecise, 30 feet)"],
    attacks: [{ name: "jaws", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "foot", traits: [], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "Until the start of your next turn, if you hit and deal damage to a creature within its reach, the creature is frightened 1.",
    source: "Pathfinder #177",
  },
  {
    slug: "ulgrem-lurann",
    ...
    size: "medium",
    hp: 6,
    abilityMods: { str: 3, dex: 2, con: 2, int: -4, wis: 0, cha: 1 },
    skill: "intimidation",
    speed: "walk 20 feet, swim 25 feet",
    senses: ["darkvision"],
    attacks: [{ name: "jaws", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "tail", traits: [], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "Until the start of your next turn, each time you hit a creature in its reach with a Strike, the creature takes an additional 1d4 piercing and 1d4 electricity damage (each 2d4 if nimble or savage).",
    source: "Monsters of Myth",
  },
  {
    slug: "umbrella mushroom",
    ...
    speed: "walk 15 feet, fly 30 feet",
    senses: ["low-light vision"],
    attacks: [{ name: "stalk", traits: [], damageDie: "1d8", damageType: "bludgeoning" }],
    support: "Until the start of your next turn, your Strikes that damage a creature within its reach make it stupefied 1 for 1 round (poison effect).",
    source: "Howl of the Wild",
    minLevel: 14,
  },
  {
    ...
    abilityMods: { str: 2, dex: 2, con: 1, int: -5, wis: 1, cha: 0 },
    skill: "none (mindless)",
    speed: "walk 20 feet, climb 20 feet",
    senses: ["darkvision"],
    attacks: [{ name: "claw", traits: ["agile","finesse"], damageDie: "1d6", damageType: "slashing" }],
    support: "Until the start of your next turn, each time you hit a creature in the hand's reach with a Strike, the creature takes 1d6 bludgeoning damage from the hand (2d6 if nimble or savage).",
    source: "Pathfinder #181",
  },
  {
    ...
    senses: ["low-light vision","scent (imprecise, 30 feet)"],
    attacks: [{ name: "jaws", traits: ["finesse"], damageDie: "1d8", damageType: "piercing" }],
    support: "Until the start of your next turn, your Strikes that damage a creature in its reach also deal 1d6 persistent bleed damage (2d6 if nimble or savage).",
    source: "Book of the Dead",
  },
  {
    slug: "vulture",
  ...
  },
  {
    ...
    size: "large",
    hp: 8,
    abilityMods: { str: 3, dex: 1, con: 2, int: -4, wis: 1, cha: 1 },
    skill: "intimidation",
    speed: "walk 35 feet",
    senses: ["low-light vision","scent (imprecise) 30 feet"],
    attacks: [{ name: "hoof", traits: ["agile"], damageDie: "1d6", damageType: "bludgeoning" }, { name: "tusk", traits: [], damageDie: "1d8", damageType: "piercing" }],
    support: "Until the start of your next turn, Strikes you make that deal damage to a creature within its reach make the target clumsy 1 until the end of your next turn.",
    source: "Pathfinder #208",
  },
  {
  ...
  },
  {
    ...
    speed: "walk 20 feet, fly 40 feet",
    senses: ["darkvision","scent (imprecise) 30 feet"],
    attacks: [{ name: "stinger", traits: [], damageDie: "1d6", damageType: "piercing" }, { name: "jaws", traits: [], damageDie: "1d8", damageType: "piercing" }], // docs: stinger "plus poison"; Unsteady Mount (full mount ability at 14th)
    support: "Until the start of your next turn, your Strikes that damage a creature in its reach also deal 1d6 persistent poison damage (2d6 if nimble or savage).",
  ...
  },
  {
    ...
    speed: "walk 40 feet",
    senses: ["low-light vision","scent (imprecise, 30 feet)"],
    attacks: [{ name: "horn", traits: [], damageDie: "1d8", damageType: "piercing" }, { name: "hoof", traits: ["agile"], damageDie: "1d6", damageType: "bludgeoning" }],
    support: "The next creature to make a melee attack against the yzobu or its rider before the start of your next turn must attempt a Fortitude save against your class or spell DC (higher); on a failure it takes a –2 circumstance penalty to its attack roll. Olfactory.",
    source: "Tian Xia Character Guide",
  },
  {
    slug: "zombie",
    ...
    size: "small", // docs: "Small or Medium"
    hp: 10,
    abilityMods: { str: 2, dex: 0, con: 4, int: -5, wis: 0, cha: 0 },
    skill: "none (mindless)",
    speed: "walk 20 feet",
    senses: ["darkvision"],
    attacks: [{ name: "fist", traits: [], damageDie: "1d8", damageType: "piercing" }],
    support: "Aura of rot. Until the start of your next turn, each time you hit a creature within 10 feet of the zombie and deal damage, it takes an additional 1d6 damage (2d6 if nimble or savage). Disease and necromancy effect.",
    source: "Book of the Dead",
  },
  {
    slug: "zombie carrion bird",
    name: "Zombie Carrion Bird",
    size: "small",
    hp: 6,
    abilityMods: { str: 2, dex: 1, con: 3, int: -5, wis: 0, cha: 0 },
    skill: "none (mindless)",
    speed: "walk 10 feet, fly 30 feet",
    senses: ["darkvision"],
    attacks: [{ name: "jaws", traits: [], damageDie: "1d8", damageType: "piercing" }],
    support: "Aura of rot, as zombie (10-foot radius, +1d6 damage, 2d6 if nimble or savage).",
    source: "Pathfinder #181",
  },
  {
    slug: "zombie mount",
    ...
    senses: ["darkvision"],
    attacks: [{ name: "hoof", traits: [], damageDie: "1d8", damageType: "bludgeoning" }],
    support: "Until the start of your next turn, each time you Strike while riding the zombie mount and hit a creature in its reach, the creature takes 1d4 bludgeoning damage (2d4 if nimble or savage).",
    source: "Pathfinder #181",
  },
];
...
const MOUNT_SLUGS = new Set([
  ...
  'riding dragonet',
  'riding drake',
  'riding tarantula', // docs: "mount at 8th level"
  'roc',
  'rootball chair',
  'shotalashu',
  'skeletal mount',
  ...
  'umbrella mushroom',
  'war pig',
  'wyvern', // docs: "Unsteady Mount" (full mount ability at 14th)
  'yzobu',
  'zombie mount',
]);
