...
const commands = [
  ...
  },
  {
    ...
    options: [
      ...
      {
        name: 'stat', description: 'Set or clear a combat stat override (AC, HP max, saves, Perception, Speed)',
        type: ApplicationCommandOptionType.Subcommand,
        options: [
          { name: 'field', description: 'Which stat to set', type: ApplicationCommandOptionType.String, required: true,
            choices: [
              { name: 'Armor Class (AC)', value: 'ac' },
              { name: 'HP (maximum)', value: 'hpMax' },
              { name: 'Fortitude save', value: 'fortitude' },
              { name: 'Reflex save', value: 'reflex' },
              { name: 'Will save', value: 'will' },
              { name: 'Perception', value: 'perception' },
              { name: 'Speed (feet)', value: 'speed' },
            ],
          },
          { name: 'value', description: 'The value to set (e.g. 18 for AC, 50 for HP max, 9 for Fort)', type: ApplicationCommandOptionType.Integer, required: false },
          { name: 'action', description: 'Use "clear" to remove an override and revert to the JSON value', type: ApplicationCommandOptionType.String, required: false,
            choices: [
              { name: 'Clear override (revert to JSON)', value: 'clear' },
            ],
          },
          { name: 'character', description: 'Which character (defaults to your active character)', type: ApplicationCommandOptionType.String, required: false, autocomplete: true },
        ],
      ...
      {
        name: 'weapon', description: 'Add, edit, or remove a weapon/attack on your character',
        type: ApplicationCommandOptionType.Subcommand,
        options: [
          { name: 'action', description: 'What to do', type: ApplicationCommandOptionType.String, required: true,
            choices: [
              { name: 'Add new weapon', value: 'add' },
              { name: 'Edit existing weapon', value: 'edit' },
              { name: 'Remove weapon', value: 'remove' },
            ],
          },
          { name: 'name', description: 'Weapon name (e.g. Longsword, +1 Shortbow)', type: ApplicationCommandOptionType.String, required: true, autocomplete: true },
          { name: 'attack', description: 'Attack bonus (the full to-hit, e.g. 10 for +10)', type: ApplicationCommandOptionType.Integer, required: false },
          { name: 'damage', description: 'Damage dice (e.g. 1d8+4, 2d6)', type: ApplicationCommandOptionType.String, required: false },
          { name: 'type', description: 'Damage type', type: ApplicationCommandOptionType.String, required: false,
            choices: [
              { name: 'Bludgeoning (B)', value: 'B' },
              { name: 'Piercing (P)', value: 'P' },
              { name: 'Slashing (S)', value: 'S' },
          ...
          { name: 'traits', description: 'Comma-separated traits (e.g. "Reach, Trip, Two-Hand d12")', type: ApplicationCommandOptionType.String, required: false },
          { name: 'character', description: 'Which character (defaults to your active character)', type: ApplicationCommandOptionType.String, required: false, autocomplete: true },
        ],
      },
      {
