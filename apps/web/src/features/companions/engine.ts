...
// and prunes sibling packages (same reason `builder/data/proficiency.ts` is
// vendored; ./proficiency here is a shim re-exporting that copy). Keep the two
// files identical below this header.
