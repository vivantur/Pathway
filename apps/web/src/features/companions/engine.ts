// Animal companion catalog + derived-stat engine.
//
...
// vendored). Keep the two files identical; when the monorepo build can resolve
// packages/core, delete this copy and import from @pathway/core again.
//
